        ...
        <div class="row">
            <div class="col-4 offset-4">
                ...
                <form action="<?=base_url('editar_puesto')?>" method="post">
                    ...
                    <input type="number" name="txt_id" id="txt_id" class="form-control" value="<?=$datos['puesto_id'];?>" readonly>
                    <label for="txt_nombre_puesto" class="form-label">Nombre del Puesto</label>
                    <input type="text" name="txt_nombre_puesto" id="txt_nombre_puesto" class="form-control" value="<?=$datos['puesto'];?>">
